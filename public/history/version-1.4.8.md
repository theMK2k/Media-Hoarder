# Media Hoarder v1.4.8 Changelog

## Updates in 1.4.7 and 1.4.8

### Fixes

IMDB, our main source of metadata, implemented measures against automated access on their website - I assume they saw a hefty influx of crawlers by those AI companies lately. This resulted in Media Hoarder not being able to scrape the main page of a movie/series/episode anymore meaning we lost access to the title, release year, genres, rating, posters and more.

For today, after a larger rewrite of our scraper, we are able to handle this, so everything is working again.

Update 1.4.8: in a longer test-run we found that after 600 media items the scraper started to fail and a restart of Media Hoarder was necessary. With v1.4.8 we improved the stability of the scraper.

## Updates in 1.4.6

### Fixes

- SCRAPER: fixed poster image scraping
