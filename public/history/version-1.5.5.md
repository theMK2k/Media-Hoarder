# Media Hoarder v1.5.5 Changelog
...
- SCRAPER: update IMDB requests (IMDB changes broke our metadata scraping) (#124)
...
Zoom ranges: 50% - 300%
Adjustable in `Settings | General` or everywhere with `CTRL` + `+` / `-` or `CTRL` + mouse wheel `up` / `down`

### Fixes

- FIX: don't show an error if IMDB does not provide parental guide for a medium (#114)
- SCRAPER: update IMDB Advanced Title Search
