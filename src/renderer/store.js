...
import * as definedError from "@helpers/defined-error.js";
...
async function fetchFilterLists($MediaType, $SpecificMediaType, loadFilterValuesFromStorage, $Series_id_Movies_Owner) {
